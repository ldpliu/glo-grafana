...
require (
	...
	github.com/grafana/grafana/pkg/apimachinery 5c243126256f // @grafana/grafana-app-platform-squad
	github.com/grafana/grafana/pkg/apiserver 5c243126256f // @grafana/grafana-app-platform-squad
